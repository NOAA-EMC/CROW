...
eval $( $HOMEcrow/to_sh.py $CONFIG_YAML scope:workflow.$TASK_PATH SCOPES:shell_env_scopes )
for scope in $SCOPES ; do
    eval $( $HOMEcrow/to_sh.py $CONFIG_YAML export:y scope:platform.general_env import:".*" )
done

eval $( $HOMEcrow/to_sh.py $CONFIG_YAML export:y scope:data_assimilation import:".*" )

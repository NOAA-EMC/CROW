...
exp_setup_string="--pslot ${pslot} --icsdir $ICS_dir --configdir ${config_dir} --comrot ${comrot} --idate $idate --edate $edate --expdir ${CHECKOUT_DIR} --resdet 192 --resens 192 --nens 20 --gfs_cyc 4"

# Kate's orginal flat snapshot
#--pslot crowflatlow --configdir /gpfs/hps3/emc/global/noscrub/emc.glopara/CROW/snapshot_flat/fv3gfs_flat/parm/config/ --idate 2018012306 --edate 2018012312 --icsdir /gpfs/hps3/emc/global/noscrub/emc.glopara/CROW/ICS --comrot /gpfs/hps2/ptmp/emc.glopara/ROTDIRS_CROW --expdir /gpfs/hps3/emc/global/noscrub/emc.glopara/CROW/snapshot_flat/ --resdet 192 --resens 192 --nens 20 --gfs_cyc 4
